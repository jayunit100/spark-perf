...
# Expects SPARK_HOME to be defined.

SPARK_HOME_DIR = "/opt/spark-1.2.0-bin-hadoop2.4"
...
#JAY: CHanged from 1.0 .  For 20 containers, use 1.0
SCALE_FACTOR = .001
...
SPARK_KEY_VAL_TEST_OPTS = [
    ...
    OptionSet("storage-location", [
        #JAY: Changed from hdfs url...
        "/tmp/spark-perf-kv-data"])
]
