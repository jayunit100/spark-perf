...
RUN HOME=/opt SPARK_MASTER_URL=127.0.0.1:1234 ./bin/run || echo "this is just for bootstrapping"
...
CMD HOME=/opt SPARK_MASTER_URL=127.0.0.1:1234 /opt/driver-script.sh
